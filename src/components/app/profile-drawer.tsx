...
import { LogOut, Globe, Lightbulb, Camera, X } from 'lucide-react';
                    ...
                    <Accordion type="single" collapsible>
                        <AccordionItem value="help">
                            ...
                            <AccordionContent className="space-y-4 pt-2 text-muted-foreground">
                                <h4 className="font-semibold text-foreground flex items-center gap-2"><Camera className="h-4 w-4" /> Camera Capture Tips</h4>
                                ...
                                <h4 className="font-semibold text-foreground flex items-center gap-2"><X className="h-4 w-4" /> Reporting Issues</h4>
                                <p className="text-sm">
                                    If you encounter any issues with the app, please contact dispatch immediately.
                                </p>
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
